    ...
    return(
        ...
        <div className="container serv">
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-4  secsection-item py-3">
                <div className="featuerslisticon " >
                <i class="fas fa-tv"></i>
                          </div>
                          <br/>
                <h6 className="secsection-title">Lorem Ipsum</h6>
...
export default Powerfuloptions;